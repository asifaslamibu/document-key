...
?>
<?php
$qry = mysqli_query($db, "select * from cabs where id='$id'"); // select query
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active1" aria-current="page"><span><?php echo $data['cabinet_name'] ?></span></li>
                            </ol>
                        </nav>
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                        <div class="col-md-2 mb-3 ml-0">
                                            <a href="ufiles.php?id=<?php echo $row["id"]; ?>&fid=<?php echo $id; ?>"><img src="assets/img/folder.png" class="card-img-top pl-4 pr-4 pt-4" alt="widget-card-2">
                                                <div class="card-body">
