 ...
 <head>
     ...
     <title>Folders - DocumentKey</title>
                     ...
                     <div class="page-header">
                         ...
                         <nav class="breadcrumb-one" aria-label="breadcrumb">
                             <ol class="breadcrumb">
                                 ...
                                 <li class="breadcrumb-item" aria-current="page"><span>Folders</span></li>
                             </ol>
                         </nav>
                                 ...
                                 <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                     <thead>
                                         <tr>
                                             ...
                                             <!-- <th>Created By</th> -->
                                             <th>Created at</th>
                                             <th class="dt-no-sorting" id="iditi">Edit</th>
                                         ...
                                         <?php
                                            ...
                                            ?>
                                             <tr>
                                                 ...
                                                 <td class="text-center" id="iditi"><a name="edit" id="<?php echo $row["id"]; ?>" class="edit_data" data-toggle="tooltip" data-placement="top" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success">
