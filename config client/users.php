 ...
 <body>
             ...
             <div class="row layout-top-spacing">
                 <div class="col-lg-12 col-12 layout-spacing">
                     <div class="statbox widget box box-shadow">
                         <div class="widget-header" id="aclss2">
                             <div class="row">
                                 <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                     <h4>Users List</h4>
                                     <button type="button" class="btn btn-primary mb-2 mr-2 float-right" id="create" data-toggle="modal" data-target="#zoomupModal">Add User</button>
                                 </div>
                             </div>
                         </div>
                                         ...
                                         <?php
                                            ...
                                            ?>
                                             <tr>
                                                 ...
                                                 <td id="iditi" class="text-center">
                                                     <a name="edit" id="<?php echo $row["id"]; ?>" class="edit_data" data-toggle="tooltip" data-placement="top" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success">
     ...
     <div id="zoomupModal" class="modal animated fadeInDown" role="dialog">
                     ...
                     <form method="post" id="insert_form" enctype="multipart/form-data">
                         ...
                         <div class="form-row mb-4">
                             <div class="col">
                                 ...
                                 <select class="placeholder js-states form-control" id="role" name="role">
                                     <!-- <option>Samad</option> -->
                                     <?php $devices = "SELECT * FROM privilege";
                                        $devices1 = mysqli_query($db, $devices);
                                        ?>
                                     <?php foreach ($devices1 as $key => $value) { ?>
                                         <option value="<?= $value['id']; ?>"><?= $value['privilege']; ?>
                                         </option>
                                     <?php
                                        }
                                        ?>
             ...
             $.ajax({
                 ...
                 success: function(data) {
                     ...
                     if (edit === 0) {
                         ...
                         var elms = document.querySelectorAll("[id='iditi']");
