 ...
 <?php
    ...
    $id = $_GET['id'];
    $result = mysqli_query($db, "SELECT * FROM `folders` where cabinet_id = $id");
    ?>
                     ...
                     <div class="page-header">
                         ...
                         <nav class="breadcrumb-one" aria-label="breadcrumb">
                             <ol class="breadcrumb">
                                 ...
                                 <li class="breadcrumb-item4" aria-current="page"><span>Folders</span></li>
                             </ol>
                         </nav>
                                     ...
                                     <?php
                                        ...
                                        ?>
                                         <div class="col-md-2 mb-3 ml-0">
                                             <a href=""><img src="assets/img/folder.png" class="card-img-top pl-4 pr-4 pt-4" alt="widget-card-2">
