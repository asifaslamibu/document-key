...
<body>
                            ...
                            <div class="row">
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="#" class="saa"
                                                    data-id="<?php echo $row["id"]; ?>" title="Edit"><svg
                                ...
                                <!-- <div class="col-md-2 mb-3 ml-0">
                                    <a href="#" data-toggle="modal" data-target=".bd-example-modal-xl"><img
                                        ...
                                        <div class="card-body">
                                            <h6 class="card-title"><?php // echo $row["doc_name"]; ?></h6>
                                            <p class="text-secondary"><?php //echo $row["uploaded_on"]; ?></p>
                                        </div>
                                    </a>
                                </div> -->
    ...
    <div class="modal fade bd-example-modal-xl" id="empModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <object style="border: none;" data-id="" standby="loading" data="" id="contentarea"
                                    type="application/pdf" width="500" height="690">
                                ...
                                <div class="input-group mb-4">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"
                                            id="basic-addon5"><?php echo $row['field_name']; ?></span>
                                    </div>
                                    <input type="text" class="form-control" id="<?php echo $row['id']; ?>"
                                        placeholder="<?php echo $row['field_name']; ?>" name="" aria-label="Username">
                                </div>
                                <?php 
                                        }
                                }
