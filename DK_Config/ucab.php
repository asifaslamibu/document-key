    ...
    //echo $user_id;
    $result = mysqli_query($db, "SELECT DISTINCT cabinet_name,c.created_at,folder_count,cabinet_id as id FROM `cabs` c inner join acl a on c.id = a.cabinet_id where a.user_id = $user_id");
    echo "SELECT DISTINCT cabinet_name,c.created_at,folder_count,cabinet_id as id FROM `cabs` c inner join acl a on c.id = a.cabinet_id where a.user_id = $user_id";
    ?>
                            ...
                            <div class="widget-content widget-content-area br-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3 ml-0">
                                        <a href="ufolder.php?id=<?php echo $row["id"]; ?>"><img src="assets/img/cab.png" width="100" height="300" class="card-img-top pl-4 pr-4 pt-4"
                                            alt="widget-card-2">
                                        
                                        <div class="card-body">
                                            <h5 class="card-title"><?php echo $row["cabinet_name"]; ?></h5>
                                            <p class="text-success"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-folder"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>&nbsp <?php echo $row["folder_count"]; ?></p>
