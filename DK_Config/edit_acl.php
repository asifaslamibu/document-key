            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing ">
                        ...
                        <form method="post" class="msgfrm" id="msgfrm">
                            <div class="row">
                                ...
                                <div class="col">
                                        ...
                                        <tr>
                                            <td id="col0">
                                                ...
                                                <input class="form-control" required type="text"
                                                    placeholder="Field Name" name="fields[]" value="" />
                                                <br>
                                            </td>
                                    ...
                                    <!-- <br/>&nbsp; -->
                                    <input class="btn btn-primary mb-3 mt-3" type="button" value="Add Row"
                                        onclick="addRows()" />
                                    &nbsp;
                                    <input type="button" value="Delete Row" class="btn btn-danger"
                                        onclick="deleteRows()" />
                                </div>
                            </div>
                            <div class="container">
                ...
                <div class="widget-content-area br-4 p-4"   >
                    <div class="widget-content widget-content-area br-6">
                        <?php
                        $result = mysqli_query($db, "SELECT * from custom_field c join folders f on f.id = c.folder_id ");
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <!-- <td ><a  href="edit_acl.php?id=<?php echo $row["id"]; ?>" class="edit_data" data-toggle="tooltip" data-placement="top" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success">
